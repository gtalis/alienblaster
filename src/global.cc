...
void initAllSurfaces() {
  ...
  surfaceDB.loadSurface(datadir + "/images/bomber.bmp");
  surfaceDB.loadSurface(datadir + "/images/bomberShadow.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/tank.bmp");
  surfaceDB.loadSurface(datadir + "/images/boss1MainGun.bmp");
  surfaceDB.loadSurface(datadir + "/images/boss1RocketLauncher.bmp");
  surfaceDB.loadSurface(datadir + "/images/boss1ShotBatteryLeft.bmp");
  surfaceDB.loadSurface(datadir + "/images/boss1ShotBatteryRight.bmp");
  surfaceDB.loadSurface(datadir + "/images/wreckFighter.bmp");
  surfaceDB.loadSurface(datadir + "/images/wreckBomber.bmp");
  surfaceDB.loadSurface(datadir + "/images/wreckTank.bmp");
  surfaceDB.loadSurface(datadir + "/images/wreckBoss1.bmp");
  surfaceDB.loadSurface(datadir + "/images/wreckBossBackground.bmp");
  surfaceDB.loadSurface(datadir + "/images/boss.bmp");
  surfaceDB.loadSurface(datadir + "/images/normalShot.bmp");
  surfaceDB.loadSurface(datadir + "/images/heavyShot.bmp");
  surfaceDB.loadSurface(datadir + "/images/normalShotHF.bmp");
  surfaceDB.loadSurface(datadir + "/images/dumbfire.bmp");
  surfaceDB.loadSurface(datadir + "/images/kickAssRocket.bmp");
  surfaceDB.loadSurface(datadir + "/images/kickAssRocketShadow.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/hellfire.bmp");
  surfaceDB.loadSurface(datadir + "/images/hellfireShadow.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/machineGun.bmp");
  surfaceDB.loadSurface(datadir + "/images/energyBeam.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/laser.bmp");
  surfaceDB.loadSurface(datadir + "/images/enemyShotNormal.bmp");
  surfaceDB.loadSurface(datadir + "/images/tankRocket.bmp");
  surfaceDB.loadSurface(datadir + "/images/tankRocketShadow.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/heatseeker.bmp");
  surfaceDB.loadSurface(datadir + "/images/shotNuke.bmp");
  surfaceDB.loadSurface(datadir + "/images/shotNukeShadow.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/nukeEffect.bmp");
  surfaceDB.loadSurface(datadir + "/images/sonic.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemPrimaryUpgrade.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemDumbfireDouble.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemKickAssRocket.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemHellfire.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemMachineGun.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemHealth.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemHeatseeker.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemNuke.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemDeflector.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemEnergyBeam.bmp");
  surfaceDB.loadSurface(datadir + "/images/itemLaser.bmp");
  surfaceDB.loadSurface(datadir + "/images/background.bmp");
  surfaceDB.loadSurface(datadir + "/images/lightFighterShieldDamaged.bmp");
  surfaceDB.loadSurface(datadir + "/images/heavyFighterShieldDamaged.bmp");
  surfaceDB.loadSurface(datadir + "/images/heavyFighterDeflector.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/font-20red.bmp");
  surfaceDB.loadSurface(datadir + "/images/font-20blue.bmp");
  surfaceDB.loadSurface(datadir + "/images/explosion.bmp");
  surfaceDB.loadSurface(datadir + "/images/explosionEnemy.bmp");
  surfaceDB.loadSurface(datadir + "/images/bannerExcellent.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/bannerYouRule.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/bannerHeiho.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/bannerHealth.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/bannerEnemysKilled.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/bannerBonus100.bmp", true);
  surfaceDB.loadSurface(datadir + "/images/bannerBonus200.bmp", true);
}
